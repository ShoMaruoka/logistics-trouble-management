...
import { Edit, Calendar, User, FileText, Clock, CheckCircle, XCircle, MapPin, Truck, AlertTriangle } from "lucide-react";
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm text-gray-600">トラブル種類</span>
                    <span className="text-sm font-medium">{incident.troubleTypeName}</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <FileText className="h-4 w-4 text-gray-500" />
                    <span className="text-sm text-gray-600">損傷の種類</span>
                    <span className="text-sm font-medium">{incident.damageTypeName}</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <MapPin className="h-4 w-4 text-gray-500" />
                    <span className="text-sm text-gray-600">出荷元倉庫</span>
                    <span className="text-sm font-medium">{incident.warehouseName}</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <Truck className="h-4 w-4 text-gray-500" />
                    <span className="text-sm text-gray-600">運送会社</span>
                    <span className="text-sm font-medium">{incident.shippingCompanyName}</span>
                  </div>
                </CardContent>
              </Card>
            </div>
